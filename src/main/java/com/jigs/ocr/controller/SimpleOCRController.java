package com.jigs.ocr.controller;
...
public class SimpleOCRController {
    ...
    @PostMapping("/readPdf")
    public @ResponseBody ResponseEntity<String> readTextFromPDFFile(@RequestParam("file") MultipartFile file) {
    	...
    	try {
            ...
            if (strippedText.trim().isEmpty()) {
                strippedText = readTextFromScannedDocument(document);
            }
    ...
    private String readTextFromScannedDocument(PDDocument document) throws IOException, TesseractException {
